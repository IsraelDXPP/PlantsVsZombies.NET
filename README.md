...
1.  使用VS2026，.NET SDK 10打开项目的slnx文件;
2.	将资源文件包（请见[联系方式](####联系方式)）解压至资源目录下;
	- PCDX/PCGL版本：解压至`Lawn_PCGL/Content`或`Lawn_PCDX/Content`
	- Android版本：解压至`Lawn_Android/Assets/Content`
3.	(可选)下载Content中文包并覆盖在资源目录下以获得中文支持;
4.	编译主程序;
5.	开始调试或运行。
...
(Android对于IronPython3脚本的修改支持暂时废弃)
